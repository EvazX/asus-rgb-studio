...
- une app Windows legere
- des apercus live des effets
- un controle global de l’intensite
- un systeme de relance automatique si un effet se coupe
- plusieurs effets perso : `Mirror`, `Ambilight`, `K2000`, `Cyberpunk`, `Aurora Drift`, `Prism Flow`, `Audio Pulse`, etc.

L’objectif est simple : rendre le RGB laptop plus beau, plus vivant et plus agreable a utiliser au quotidien.

## Positionnement

Ce n’est pas un clone d’Armoury Crate.

L’idee est plutot :

- garder le controle local
- avoir une interface plus directe
- proposer des effets custom plus stylises
- rendre le tout partageable et evolutif

## Ce que j’aimerais faire ensuite

- modes `Cinema` et `FPS`
- davantage d’effets portes en C#
- interface encore plus premium
- meilleure detection / exploitation de la structure RGB interne du clavier ASUS
